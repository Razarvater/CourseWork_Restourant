...
--Процедура подписки пользователя на ЧЁРТОВУ ТАБЛИЦУ
...
--Процедура отписки пользователя от таблицы
...
EXEC [DropListenerNotifications];
...
END;
EXEC [DropListenerNotifications];
EXEC [InstallListenerNotifications];

--процедура инициализации общих триггеров
